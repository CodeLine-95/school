<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/updateschool.html";i:1547575487;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">添加校区</div>
          <div class="layui-card-body" pad15>
            
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                <label class="layui-form-label">校区标题</label>
                <div class="layui-input-block">
                  <input type="hidden" name="id" value="<?php echo $school['id']; ?>">
                  <input type="text" name="name" value="<?php echo $school['name']; ?>" autocomplete="off" placeholder="请输入公告标题" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">文章关键词</label>
                <div class="layui-input-block">
                  <input type="text" name="keywords" value="<?php echo $school['keywords']; ?>" autocomplete="off" placeholder="请输入文章关键词" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">文章描述</label>
                <div class="layui-input-block">
                  <textarea name="description" placeholder="请输入文章描述" class="layui-textarea"><?php echo $school['description']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">校区负责人</label>
                <div class="layui-input-block">
                  <input type="text" name="rector" value="<?php echo $school['rector']; ?>" autocomplete="off" placeholder="请输入校区负责人" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">校区地址</label>
                <div class="layui-input-block">
                  <input type="text" name="address" value="<?php echo $school['address']; ?>" autocomplete="off" placeholder="请输入校区地址" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">校区电话</label>
                <div class="layui-input-block">
                  <input type="text" name="tel" value="<?php echo $school['tel']; ?>" autocomplete="off" placeholder="请输入校区电话" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                  <label class="layui-form-label">展示图片</label>
                  <div class="controls need-img">
                      <button type="button" class="layui-btn layui-btn-primary" id="upload_img_icon">上传校区展示图片</button>
              ...
              <div class="layui-form-item">
                  <label for="content" class="layui-form-label">
                      <span class="x-red">*</span>校区详情
                  </label>
                  <div class="layui-input-block">
                      <textarea placeholder="请输入校区详情" id="content" name="content" ><?php echo $school['content']; ?></textarea>
                  </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
...
<script type="text/javascript">
    ...
    <script>
        layui.use(['form','layer','upload'], function(){
          ...
          var upurl = "<?php echo url('system/upload'); ?>"; //上传图片地址
          ...
          upload.render({
              ...
              choose: function(obj){
                  ...
                  obj.preview(function(index, file, result){
                      ...
                      //可以在这里用ajax 请求后台上传校区  ，或者获取img标签src 上传
                      $.ajax({
                        url:'<?php echo url("index/upload"); ?>',
                        type:"POST",
                        data:{
              ...
              form.on('submit(setmyinfo)', function(data){
                ...
                $.ajax({
                    url:"<?php echo url('index/updateschool'); ?>",
                    type:"POST",
                    data: {
        ...
        function ImgToBase64(file, maxLen, callBack) {
            ...
            reader.onload = function () {
                ...
                img.src = url;//reader读取的文件内容是base64,利用这个url就能实现上传前预览校区
            };
...
function imgas()
{
  var id = "<?php echo $school['id']; ?>"; 
  $.ajax({
    url:"<?php echo url('index/schoolpath'); ?>",
    data:{id:id},
    type:"post",
    success:function(data)
    {
