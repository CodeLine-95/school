<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/updatephoto.html";i:1547490260;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  ...
                  <input type="text" name="name" value="<?php echo $photo['name']; ?>" autocomplete="off" placeholder="请输入公告标题" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="path" id="ser_pic2" value="<?php echo $photo['path']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      ...
                      <?php if(empty($photo['path']) || (($photo['path'] instanceof \think\Collection || $photo['path'] instanceof \think\Paginator ) && $photo['path']->isEmpty())): ?>
                      <div style="clear: both;display:none" id="imgs">
                        <?php else: ?>
                        <div style="clear: both;" id="imgs">
                        <?php endif; ?>
                          <img src="<?php echo $photo['path']; ?>" alt="<?php echo $photo['path']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('index/updatephoto'); ?>",
                    type:"POST",
                    data: {
