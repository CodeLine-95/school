<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/updatecourse.html";i:1547546601;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">编辑大事件</div>
          <div class="layui-card-body" pad15>
            
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                <label class="layui-form-label">大事件名称</label>
                <div class="layui-input-block">
                  <input type="hidden" name="id" value="<?php echo $course['id']; ?>">
                  <input type="text" name="name" value="<?php echo $course['name']; ?>" autocomplete="off" placeholder="请输入公司名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">大事件描述</label>
                <div class="layui-input-block">
                  <textarea name="content" placeholder="请输入大事件描述" class="layui-textarea"><?php echo $course['content']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
                  <label for="ser_pic" class="layui-form-label">大事件图片</label>
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="img" id="ser_pic2" value="<?php echo $course['img']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      <button type="button" id="ser_pic" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传大事件图片</button>
                      <button type="button" style="display: none;" id="demoAction" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传demo</button>
                      <?php if(empty($course['img']) || (($course['img'] instanceof \think\Collection || $course['img'] instanceof \think\Paginator ) && $course['img']->isEmpty())): ?>
                        <div style="clear: both;display:none" id="imgs">
                      <?php else: ?>
                         <div style="clear: both;" id="imgs">
                      <?php endif; ?>
                          <img src="<?php echo $course['img']; ?>" alt="<?php echo $course['img']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">大事件日期</label>
                <div class="layui-input-inline">
                  <input type="text" name="time" id="date" lay-verify="date" placeholder="请选择时间发生时间" value="<?php echo date('Y-m-d',$course['time']); ?>" autocomplete="off" class="layui-input" >
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
        ...
        layui.use(['form','layer','upload','laydate'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('index/updatecourse'); ?>",
                    type:"POST",
                    data: {
