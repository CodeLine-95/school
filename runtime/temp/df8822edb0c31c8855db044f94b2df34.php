<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/about/addteacher.html";i:1547577097;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="name" value="" autocomplete="off" placeholder="请输入名师名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">名师岗位</label>
                <div class="layui-input-block">
                  <input type="text" name="post" value="" autocomplete="off" placeholder="请输入名师岗位" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">名师简介</label>
                <div class="layui-input-block">
                  <textarea name="intro" placeholder="请输入名师简介" class="layui-textarea"></textarea>
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">名师语录</label>
                <div class="layui-input-block">
                  <textarea name="sign" placeholder="请输入名师语录" class="layui-textarea"></textarea>
                </div>
              </div>
              <div class="layui-form-item">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('about/addteacher'); ?>",
                    type:"POST",
                    data: {
