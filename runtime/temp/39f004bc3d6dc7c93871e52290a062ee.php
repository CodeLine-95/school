<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/art/updatetype.html";i:1547179669;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547182646;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  ...
                  <input type="text" name="typename" value="<?php echo $type['typename']; ?>" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                  <label for="ser_pic" class="layui-form-label">分类图片</label>
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="img" id="ser_pic2" value="<?php echo $type['img']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      ...
                      <?php if(empty($type['img']) == false): ?>
                        <div style="clear: both;" id="imgs">
                      <?php else: ?>
                        <div style="clear: both;display:none" id="imgs">
                      <?php endif; ?>
                          <img src="<?php echo $type['img']; ?>" alt="<?php echo $type['img']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('art/updatetype'); ?>",
                    type:"POST",
                    data: {
