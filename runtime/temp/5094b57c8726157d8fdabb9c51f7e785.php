<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/school.html";i:1547573520;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
              <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('添加校区','<?php echo url('index/addschool'); ?>')"><i class="layui-icon">&#xe608;</i>添加校区</button>
                ...
                <tbody>
                  ...
                  <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                    <tr>
                     ...
                     <td><?php echo $vv['rector']; ?></td>
                     <td><?php echo $vv['address']; ?></td>
                     <td><?php echo date('Y年m月d日 h:i:s',$vv['createtime']); ?></td>
                     <td>
                        <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('修改校区信息','<?php echo url('index/updateschool',['id'=>$vv['id']]); ?>')">
  ...
  <script>
    function del(id)
    {
      layer.confirm("您确定删除此校区吗",function(){
          $.ajax({
            url:"<?php echo url('index/delschool'); ?>",
            data:{id:id},
            type:"post",
