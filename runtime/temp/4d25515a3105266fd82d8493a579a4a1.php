<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/updateurl.html";i:1547528837;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">添加友链</div>
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  ...
                  <input type="text" name="name" value="<?php echo $url['name']; ?>" autocomplete="off" placeholder="请输入友链名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">友链</label>
                <div class="layui-input-block">
                  <input type="text" name="url" value="<?php echo $url['url']; ?>" autocomplete="off" placeholder="请输入友链" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('index/updateurl'); ?>",
                    type:"POST",
                    data: {
