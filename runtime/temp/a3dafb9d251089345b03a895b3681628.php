<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/urls.html";i:1547528060;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
              <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('添加图片','<?php echo url('index/addurl'); ?>')"><i class="layui-icon">&#xe608;</i>添加友链</button>
            <table class="layui-table">
                ...
                <tbody>
                  <?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
                   <tr align="center" style="height:500px;"><td colspan="5">暂无友链</td></tr>
                  <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                    <tr>
                     ...
                     <td>
                        <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('修改友链信息','<?php echo url('index/updateurl',['id'=>$vv['id']]); ?>')">
  ...
  <script>
    function del(id)
    {
      layer.confirm("您确定删除此友链吗",function(){
          $.ajax({
            url:"<?php echo url('index/delurl'); ?>",
            data:{id:id},
            type:"post",
