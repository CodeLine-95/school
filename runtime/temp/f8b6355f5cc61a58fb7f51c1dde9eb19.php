<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/system/index.html";i:1547279690;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="title" value="<?php echo $system['title']; ?>"  placeholder="请在此输入网站名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">网站关键词</label>
                <div class="layui-input-block">
                  <input type="text" name="keywords" value="<?php echo $system['keywords']; ?>" lay-verify="user_nick" autocomplete="off" placeholder="多个网站关键词之间用英文逗号隔开" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="logo" id="ser_pic2" value="<?php echo $system['logo']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      ...
                      <button type="button" style="display: none;" id="demoAction" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传demo</button>
                        <?php if(empty($system['logo']) == false): ?>
                         <div style="clear: both;" id="imgs">
                        <?php else: ?>
                         <div style="clear: both;display:none" id="imgs">
                        <?php endif; ?>
                          <img src="<?php echo $system['logo']; ?>" alt="<?php echo $system['logo']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="icon" id="ser_pics2" value="<?php echo $system['icon']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      <button type="button" id="ser_pics" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传小图标</button>
                      <button type="button" style="display: none;" id="demoAction" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传demo</button>
                        <?php if(empty($system['icon']) == false): ?>
                         <div style="clear: both;" id="imgs">
                        <?php else: ?>
                         <div style="clear: both;display:none" id="imgs">
                        <?php endif; ?>
                          <img src="<?php echo $system['icon']; ?>" alt="<?php echo $system['icon']; ?>" id="ser_pic_imgs" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                  <textarea name="description" placeholder="请输入站点描述内容" class="layui-textarea"><?php echo $system['description']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
              ...
              <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                  <textarea name="copy" placeholder="请输入站点版权信息" class="layui-textarea"><?php echo $system['copy']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
...
{
  $.ajax({
    url:"<?php echo url('system/imghaha'); ?>",
    data:{},
    type:"post",
    success:function(data)
    {
