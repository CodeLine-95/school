<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/xiong.html";i:1547547953;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <div class="layui-row layui-col-space15">
      <div class="layui-col-md12">
        <div class="layui-card">
          <div class="layui-card-header">设置公司熊掌号</div>
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="hidden" name="id" value="<?php echo $xiong['id']; ?>">
                  <input type="text" name="login" value="<?php echo $xiong['login']; ?>" autocomplete="off" placeholder="请输入登陆账号" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">登陆密码</label>
                <div class="layui-input-block">
                  <input type="text" name="password" value="<?php echo $xiong['password']; ?>" autocomplete="off" placeholder="请输入登陆密码" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">熊掌号appid</label>
                <div class="layui-input-block">
                  <input type="text" name="appid" value="<?php echo $xiong['appid']; ?>" autocomplete="off" placeholder="请输入熊掌号appid" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">熊掌号token</label>
                <div class="layui-input-block">
                  <input type="text" name="token" value="<?php echo $xiong['token']; ?>" autocomplete="off" placeholder="请输入熊掌号token" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">绑定手机号</label>
                <div class="layui-input-block">
                  <input type="text" name="phone" value="<?php echo $xiong['phone']; ?>" autocomplete="off" placeholder="请输入绑定的手机号" class="layui-input">
                </div>
              </div>
