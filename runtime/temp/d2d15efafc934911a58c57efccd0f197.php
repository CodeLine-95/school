<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/updatehand.html";i:1547531122;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="hidden" name="id" value="<?php echo $hand['id']; ?>">
                  <input type="text" name="name" value="<?php echo $hand['name']; ?>" autocomplete="off" placeholder="请输入公司名称" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">官网地址</label>
                <div class="layui-input-block">
                  <input type="text" name="website" value="<?php echo $hand['website']; ?>" autocomplete="off" placeholder="请输入官网地址" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">合作关系</label>
                <div class="layui-input-block">
                  <input type="text" name="hand" value="<?php echo $hand['hand']; ?>" autocomplete="off" placeholder="请输入合作关系" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">公司描述</label>
                <div class="layui-input-block">
                  <textarea name="intro" placeholder="请输入公司描述" class="layui-textarea"><?php echo $hand['intro']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="logo" id="ser_pic2" value="<?php echo $hand['logo']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      ...
                      <?php if(empty($hand['logo']) || (($hand['logo'] instanceof \think\Collection || $hand['logo'] instanceof \think\Paginator ) && $hand['logo']->isEmpty())): ?>
                        <div style="clear: both;display:none" id="imgs">
                      <?php else: ?>
                        <div style="clear: both;" id="imgs">
                      <?php endif; ?>
                          <img src="<?php echo $hand['logo']; ?>" alt="<?php echo $hand['logo']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
                      </div>
                  </div>
                </div>
              <div class="layui-form-item">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('index/updatehand'); ?>",
                    type:"POST",
                    data: {
