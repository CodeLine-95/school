<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/notice/index.html";i:1547388212;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
              <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('添加公告','<?php echo url('notice/add'); ?>')"><i class="layui-icon">&#xe608;</i>添加公告</button>
                ...
                <tbody>
                  ...
                  <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                    <tr>
                     ...
                     <td><?php echo $vv['keywords']; ?></td>
                     <td><?php echo date('Y年m月d日 h:i:s',$vv['createtime']); ?></td>
                     <td><?php if(empty($vv['issuetime']) || (($vv['issuetime'] instanceof \think\Collection || $vv['issuetime'] instanceof \think\Paginator ) && $vv['issuetime']->isEmpty())): ?>暂未发布<?php else: ?><?php echo date('Y年m月d日 h:i:s',$vv['issuetime']); endif; ?></td>
                     <td>
                        <button class="layui-btn layui-btn-sm"><i class="layui-icon">&#xe629;</i></button>
                        <button class="layui-btn layui-btn-sm" onclick="status('<?php echo $vv['id']; ?>','<?php echo $vv['status']; ?>')"><i class="layui-icon">&#xe628;</i></button>
                        <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('编辑公告','<?php echo url('notice/update',['id'=>$vv['id']]); ?>')">
  ...
  <script>
    ...
    function status(id,status)
    {
      ...
      layer.confirm(tishi,function(){
        $.ajax({
          url:"<?php echo url('notice/status'); ?>",
