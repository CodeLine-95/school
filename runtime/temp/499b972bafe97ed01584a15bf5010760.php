<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/addschool.html";i:1547574974;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="layui-card-body" pad15>
            ...
            <div class="layui-form" lay-filter="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="keywords" value="" autocomplete="off" placeholder="请输入文章关键词" class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="rector" value="" autocomplete="off" placeholder="请输入校区负责人" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">校区地址</label>
                <div class="layui-input-block">
                  <input type="text" name="address" value="" autocomplete="off" placeholder="请输入校区地址" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
                <label class="layui-form-label">校区电话</label>
                <div class="layui-input-block">
                  <input type="text" name="tel" value="" autocomplete="off" placeholder="请输入校区电话" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                  ...
                  <div class="layui-input-block">
                      <textarea placeholder="请输入校区详情" id="content" name="content" ></textarea>
                  </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                ...
                $.ajax({
                    url:"<?php echo url('index/addschool'); ?>",
                    type:"POST",
                    data: {
