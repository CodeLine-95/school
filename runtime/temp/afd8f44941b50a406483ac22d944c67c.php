<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/notice/update.html";i:1547387544;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <div class="layui-form" lay-filter="">
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                  <input type="text" name="name" value="<?php echo $notice['name']; ?>" autocomplete="off" placeholder="请输入公告标题" class="layui-input">
                </div>
              </div>

              <div class="layui-form-item">
                <label class="layui-form-label">公告关键词</label>
                <div class="layui-input-block">
                  <input type="text" name="keywords" value="<?php echo $notice['keywords']; ?>" autocomplete="off" placeholder="请输入公告关键词" class="layui-input">
                </div>
              </div>
              <div class="layui-form-item layui-form-text">
                <label class="layui-form-label">公告描述</label>
                <div class="layui-input-block">
                  <textarea name="description" placeholder="请输入公告描述" class="layui-textarea"><?php echo $notice['description']; ?></textarea>
                </div>
              </div>
              <div class="layui-form-item">
                  <label for="ser_pic" class="layui-form-label">公告缩略图</label>
                  <div class="layui-input-block">
                      <div style="float: left;margin-right: 10px;">
                          <input type="text" name="path" id="ser_pic2" value="<?php echo $notice['path']; ?>" style="float: left;width: 800px;" required="" autocomplete="off" class="layui-input" readonly>
                      </div>
                      <button type="button" id="ser_pic" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传公告缩略图</button>
                      <button type="button" style="display: none;" id="demoAction" class="layui-btn"><i class="layui-icon">&#xe67c;</i>上传demo</button>
                      <?php if(empty($notice['path']) || (($notice['path'] instanceof \think\Collection || $notice['path'] instanceof \think\Paginator ) && $notice['path']->isEmpty())): ?>
                      <div style="clear: both;display:none" id="imgs">
                      <?php else: ?>
                      <div style="clear: both;" id="imgs">
                      <?php endif; ?>
                          <img src="<?php echo $notice['path']; ?>" alt="<?php echo $notice['path']; ?>" id="ser_pic_img" style="max-width: 500px;max-height: 200px;">
              ...
              <div class="layui-form-item">
                  <label for="content" class="layui-form-label">
                      <span class="x-red">*</span>公告详情
                  </label>
                  <div class="layui-input-block">
                      <textarea placeholder="请输入公告详情" id="content" name="content" ><?php echo $notice['content']; ?></textarea>
                  </div>
              </div>
              <div class="layui-form-item">
                <div class="layui-input-block">
