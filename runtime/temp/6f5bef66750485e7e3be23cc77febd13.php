<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/power/poweredit.html";i:1547450179;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;s:70:"/home/wwwroot/school.wxn.fun/application/admin/view/public/footer.html";i:1547120642;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <!DOCTYPE html>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select id="pid" name="pid" class="valid">
                        ...
                        <option value="<?php echo $rule['id']; ?>" <?php if($field['pid'] == $rule['id']): ?>selected<?php endif; ?>><?php echo $rule['_name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
              </div>
