<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/index/addphoto.html";i:1547490704;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        layui.use(['form','layer','upload'], function(){
          ...
          upload.render({
              ...
              form.on('submit(setmyinfo)', function(data){
                //发异步，把数据提交给php
                $.ajax({
                    url:"<?php echo url('index/addphoto'); ?>",
                    type:"POST",
                    data: {
