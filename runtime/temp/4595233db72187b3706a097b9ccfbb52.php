<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/home/wwwroot/school.wxn.fun/public/../application/admin/view/about/teacher.html";i:1547577134;s:69:"/home/wwwroot/school.wxn.fun/application/admin/view/public/title.html";i:1547449831;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
              <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('添加名师','<?php echo url('about/addteacher'); ?>')"><i class="layui-icon">&#xe608;</i>添加名师</button>
                ...
                <tbody>
                  ...
                  <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
                    <tr>
                     ...
                     <td> <div style="width:100px;height:80px;"><img src="<?php echo $vv['logo']; ?>" alt="" style="width:100%;"></div></td>
                     <td><?php echo $vv['post']; ?></td>
                     <td><?php echo date('Y年m月d日 h:i:s',$vv['createtime']); ?></td>
                     <td>
                        <button class="layui-btn layui-btn-sm" onclick="crm_admin_show('修改名师信息','<?php echo url('about/updateteacher',['id'=>$vv['id']]); ?>')">
  ...
  <script>
    function del(id)
    {
      layer.confirm("您确定删除此名师吗",function(){
          $.ajax({
            url:"<?php echo url('about/delteacher'); ?>",
            data:{id:id},
            type:"post",
